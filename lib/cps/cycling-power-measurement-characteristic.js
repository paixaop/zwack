...
class CyclingPowerMeasurementCharacteristic extends  Bleno.Characteristic {
  ...
  onSubscribe(maxValueSize, updateValueCallback) {
    console.log('[CyclingPowerMeasurementCharacteristic] client subscribed to PM');
    this._updateValueCallback = updateValueCallback;
    return this.RESULT_SUCCESS;
  };

  onUnsubscribe() {
    console.log('[CyclingPowerMeasurementCharacteristic] client unsubscribed from PM');
    this._updateValueCallback = null;
